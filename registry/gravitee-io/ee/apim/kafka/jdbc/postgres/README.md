---
title: "APIM - Kafka JDBC PostgreSQL"
description: "Gravitee APIM with Kafka Gateway and PostgreSQL JDBC backend"
tags: [networking, messaging]
---

# APIM Kafka JDBC PostgreSQL

Deploys a full Gravitee API Management stack with Kafka Gateway enabled,
backed by PostgreSQL via JDBC for persistence and Elasticsearch for analytics.
